...
async function main() {
  ...
  const modpacksToSeed = [
    ...
    {
      name: "Saints Dinosaur Survival Survival Evolved",
      slug: "saints-Dinosaur Survival-survival",
      game: "Dinosaur Survival: Survival Evolved",
      description: "The ultimate Dinosaur Survival mod pack for the Saints Gaming community. Rebuilt for balanced PvE and PvP.",
      version: "2.3.4",
      installNotes: "Subscribe to the Steam Workshop collection.",
      order: 3
    },
    {
      name: "Post-Apoc Survival Saints Reborn",
      slug: "Post-Apoc Survival-saints-reborn",
      game: "Post-Apoc Survival",
      description: "Custom plugins and configurations for our Post-Apoc Survival community server.",
      version: "1.1.0",
      order: 4
    },
    {
