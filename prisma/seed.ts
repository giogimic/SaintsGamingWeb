...
async function main() {
  ...
  const newsArticles = [
    ...
    { title: "Creature Battler Server Wipes & Fresh Start", excerpt: "Detailing the schedule for the upcoming wipes...", body: "Wipe incoming this weekend!" },
    ...
    { title: "Creature Battler Patch 0.2.0: What You Need to Know", excerpt: "A breakdown of the latest patch...", body: "Lots of balance changes." },
  ...
  const categories = [
    ...
    { 
      name: "Creature Battler Servers", 
      slug: "Creature Battler",
      subcategories: [
        { name: "Creature Battler General", slug: "Creature Battler-general", description: "General discussion for Creature Battler" },
        { name: "Tribes & Recruitment", slug: "Creature Battler-tribes", description: "Find players for your tribe" }
      ]
    },
    { 
      name: "Support", 
