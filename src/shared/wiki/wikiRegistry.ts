...
export const WIKI_CATEGORIES: WikiCategory[] = [
  {
    ...
    articles: [
      ...
      },
      {
        ...
        summary: "Clone, install, configure .env, and run the development server locally.",
        readTime: 3,
        categoryId: "getting-started",
        tags: ["install", "setup", "node", "prisma", "npm", "dev server"],
      ...
      },
      {
        ...
        summary: "High-level architecture of the Next.js + Go MMO + Babylon.js stack.",
        readTime: 5,
        categoryId: "getting-started",
        tags: ["architecture", "next.js", "go", "babylon", "stack"],
    ...
    articles: [
      {
        ...
        title: "Core Loop & 2.5D Renderer",
        summary: "The requestAnimationFrame game loop, Babylon.js orthographic camera, sprite projection, and tile batching.",
        readTime: 5,
        categoryId: "game-systems",
        tags: ["game loop", "renderer", "babylon", "canvas", "requestAnimationFrame", "orthographic"],
    ...
    articles: [
      {
        ...
        summary: "Docking shell, Zustand state management, 5 core editor modes, omnisearch, and hotkeys.",
        readTime: 4,
        categoryId: "studio",
        tags: ["studio", "editor", "modes", "docking", "hotkeys"],
        filePath: "studio/overview.md",
        order: 0,
      },
      {
        slug: "studio/tile-painting-maps",
        title: "Tile Painting & Maps",
        summary: "Dual-grid architecture, visual vs logic layers, painting tools, and incremental remeshing.",
        readTime: 4,
        categoryId: "studio",
        tags: ["tiles", "painting", "maps", "dual-grid", "logic", "brush"],
      ...
      },
      {
        ...
        summary: "LPC sprite compositing pipeline, tileset importing, and asset organization.",
        readTime: 3,
        categoryId: "studio",
        tags: ["assets", "sprites", "lpc", "tilesets", "importing"],
    ...
    articles: [
      {
        ...
        summary: "Design player archetypes with LPC sprite compositing, stat distributions, and starter loadouts.",
        readTime: 5,
        categoryId: "creator-guide",
        tags: ["characters", "sprites", "lpc", "archetypes", "customization"],
