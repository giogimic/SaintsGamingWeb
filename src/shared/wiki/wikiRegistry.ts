...
export const WIKI_CATEGORIES: WikiCategory[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        summary: "Saints combat model: real-time open-world Monster Battles alongside turn-based, capture-focused Creature Battles.",
        readTime: 5,
        categoryId: "game-systems",
        tags: ["combat", "monster battles", "creature battles", "capture", "turn-based", "action combat", "elemental"],
  ...
  },
  {
    id: "studio",
    title: "World Studio",
    description: "Technical manuals for the creator suite: Tile Maps, Voxel Maps, Fractal Domains, catalogs, and playtesting.",
    icon: "Sparkles",
    ...
    articles: [
      {
        ...
        summary: "Docking shell, editor modes, and the separate Tile Map, Voxel Map, and Fractal Domain authoring systems.",
        readTime: 5,
        categoryId: "studio",
        tags: ["studio", "editor", "modes", "docking", "tile maps", "voxel maps", "fractal domains", "desktop", "electron"],
        filePath: "studio/overview.md",
        order: 0,
      },
      {
        slug: "studio/tile-painting-maps",
        title: "Tile Maps, Voxel Maps & Fractal Domains",
        summary: "The boundaries between finite Tile Maps, finite Voxel Maps, and infinite procedural Fractal Domains, plus their authoring tools.",
        readTime: 5,
        categoryId: "studio",
        tags: ["tile maps", "voxel maps", "fractal domains", "procedural", "blocks", "layers", "tools", "remeshing", "collision"],
      ...
      },
      {
        ...
        summary: "Archetype, modular Class, Creature, Monster, item, ability, quest, and dialogue definition editors.",
        readTime: 3,
        categoryId: "studio",
        tags: ["catalogs", "definitions", "archetypes", "classes", "creatures", "monsters", "abilities", "items", "quests"],
    ...
    articles: [
      {
        ...
        summary: "Design playable Archetypes with modular Classes, sprite compositing, starting configuration, and loadouts.",
        readTime: 5,
        categoryId: "creator-guide",
        tags: ["characters", "sprites", "modular", "archetypes", "classes", "customization"],
      ...
      },
      {
        ...
        summary: "Create Creatures for turn-based capture encounters and, when configured, real-time Monster Battle spawns.",
        readTime: 5,
        categoryId: "creator-guide",
        tags: ["creatures", "monster battles", "creature battles", "capture", "evolutions", "moves", "types"],
      ...
      },
      {
        ...
        summary: "Build connected Tile and Voxel Maps, configure Fractal Domains, and populate worlds with warps, biomes, and NPCs.",
        readTime: 5,
        categoryId: "creator-guide",
        tags: ["world", "tile maps", "voxel maps", "fractal domains", "warps", "biomes", "zones", "atlas"],
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        summary: "Canonical Saints terminology for Archetypes, Classes, Creature Battles, Monster Battles, and map authoring.",
        readTime: 3,
        categoryId: "api-and-reference",
