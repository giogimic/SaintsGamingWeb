...
export const SUPERIOR_MONSTER_REGISTRY: Record<string, SuperiorMonsterDef> = {
  ...
  bloodveld: { baseMonsterId: 'bloodveld', superiorId: 'insatiable_bloodveld', name: 'Insatiable Bloodveld', slayerLevelReq: 50, hp: 450, combatLevel: 182, xpMultiplier: 10 },
  ...
  dust_devil: { baseMonsterId: 'dust_devil', superiorId: 'choke_devil', name: 'Choke Devil', slayerLevelReq: 65, hp: 420, combatLevel: 215, xpMultiplier: 10 },
