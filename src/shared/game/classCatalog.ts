...
export const DEFAULT_PLAYABLE_CLASSES: ClassDefData[] = [
  {
    ...
    abilities: ["slash", "taunt", "shield_bash"],
    isPlayable: true,
    sortOrder: 1,
  },
  {
    ...
    perks: ["STAMINA_SURGE"],
    abilities: ["fireball", "frost_nova", "arcane_barrier"],
    isPlayable: true,
    sortOrder: 2,
  },
  {
    ...
    perks: ["ACROBAT"],
    abilities: ["quick_shot", "dodge_roll", "trap_snare"],
    isPlayable: true,
    sortOrder: 3,
  },
  {
    ...
    perks: ["PACK_MULE"],
    abilities: ["radiant_smite", "healing_light", "aegis_aura"],
    isPlayable: true,
    sortOrder: 4,
  },
  {
    ...
    perks: ["MASTER_TAMER"],
    abilities: ["greater_heal", "divine_shield", "smite"],
    isPlayable: true,
    sortOrder: 5,
  },
];
