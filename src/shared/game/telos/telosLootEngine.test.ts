...
describe('Telos Loot & Weapon Assembly Engine', () => {
  ...
  it('assembles finished Tier 92 weapons using 3 Anima Orbs and dormant base', () => {
    ...
    const failRes = assembleTelosWeapon('dormant_staff_of_sliske', {
      hasVolcanicOrb: true,
    ...
    const passRes = assembleTelosWeapon('dormant_staff_of_sliske', {
      hasVolcanicOrb: true,
      hasCorruptedOrb: true,
      hasPureOrb: true,
    });
