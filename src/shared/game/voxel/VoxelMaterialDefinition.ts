...
export const VOXEL_MATERIAL_CATALOG: Record<number, VoxelMaterialDefinition> = {
  ...
  [VOXEL_MAT_FARMLAND_DRY]: {
    id: VOXEL_MAT_FARMLAND_DRY,
    slug: 'farmland_dry',
    name: 'Tilled Soil (Dry)',
    textureSource: CANONICAL_VOXEL_TEXTURE,
    colorHex: '#8d6e63',
    tintRgba: [0.75, 0.58, 0.45, 1.0],
    faceMapping: {
      top: UV_DIRT,
      bottom: UV_DIRT,
      north: UV_DIRT,
  ...
  [VOXEL_MAT_FARMLAND_MOIST]: {
    id: VOXEL_MAT_FARMLAND_MOIST,
    slug: 'farmland_moist',
    name: 'Tilled Soil (Hydrated)',
    textureSource: CANONICAL_VOXEL_TEXTURE,
    colorHex: '#3e2723',
    tintRgba: [0.42, 0.30, 0.22, 1.0],
    faceMapping: {
      top: UV_DIRT,
      bottom: UV_DIRT,
      north: UV_DIRT,
  ...
  [VOXEL_MAT_CROP_WHEAT]: {
    id: VOXEL_MAT_CROP_WHEAT,
    slug: 'crop_wheat',
    name: 'Golden Grain Crop',
    textureSource: CANONICAL_VOXEL_TEXTURE,
    colorHex: '#eab308',
    tintRgba: [0.95, 0.85, 0.30, 1.0],
    faceMapping: {
      top: UV_GRASS_TOP,
      bottom: UV_GRASS_TOP,
      north: UV_GRASS_TOP,
  ...
  [VOXEL_MAT_CROP_CARROT]: {
    id: VOXEL_MAT_CROP_CARROT,
    slug: 'crop_carrot',
    name: 'Harvest Carrot Crop',
    textureSource: CANONICAL_VOXEL_TEXTURE,
    colorHex: '#f97316',
    tintRgba: [0.95, 0.55, 0.20, 1.0],
    faceMapping: {
      top: UV_GRASS_TOP,
      bottom: UV_GRASS_TOP,
      north: UV_GRASS_TOP,
  ...
  [VOXEL_MAT_CROP_HERB]: {
    id: VOXEL_MAT_CROP_HERB,
    slug: 'crop_herb',
    name: 'Medicinal Herb Crop',
    textureSource: CANONICAL_VOXEL_TEXTURE,
    colorHex: '#10b981',
    tintRgba: [0.25, 0.85, 0.45, 1.0],
    faceMapping: {
      top: UV_GRASS_TOP,
      bottom: UV_GRASS_TOP,
      north: UV_GRASS_TOP,
  ...
  [VOXEL_MAT_FOLIAGE_FLOWER]: {
    id: VOXEL_MAT_FOLIAGE_FLOWER,
    slug: 'foliage_flower',
    name: 'Wild Meadow Blossom',
    textureSource: CANONICAL_VOXEL_TEXTURE,
    colorHex: '#ec4899',
    tintRgba: [0.95, 0.40, 0.65, 1.0],
    faceMapping: {
      top: UV_GRASS_TOP,
      bottom: UV_GRASS_TOP,
      north: UV_GRASS_TOP,
