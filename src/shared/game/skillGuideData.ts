...
export const SKILL_GUIDE_REGISTRY: Record<string, SkillGuideEntry> = {
  ...
  strength: {
    ...
    staticMilestones: [
      { level: 1, title: 'Basic Physicality', description: 'Equip basic bronze clubs and wooden mauls.', type: 'EQUIPMENT' },
      { level: 5, title: 'Power Strike', description: 'Unlocks the Power Strike heavy attack ability.', type: 'ABILITY' },
      { level: 10, title: 'Iron Warhammer', description: 'Equip Iron Warhammers and two-handed Greatswords.', type: 'EQUIPMENT' },
      { level: 20, title: 'Ground Slam', description: 'AoE shockwave dealing high poise damage to nearby foes.', type: 'ABILITY' },
      { level: 30, title: 'Mithril Colossus Hammer', description: 'Equip heavy Mithril bludgeons.', type: 'EQUIPMENT' },
      { level: 40, title: 'Titan Smash', description: 'Devastating overhead strike that shatters armor by 30%.', type: 'ABILITY' },
      { level: 50, title: 'Immortal Brawn', description: 'Passive: Physical melee attacks ignore 25% of target armor.', type: 'PASSIVE' },
    ],
    battlepassTiers: [
      { tier: 1, level: 5, rewardName: 'Title: Brawler', rewardType: 'TITLE', description: 'Unlocks the [Brawler] title.', iconName: 'Award', rarity: 'COMMON' },
      { tier: 2, level: 10, rewardName: 'Emote: Muscle Flex', rewardType: 'EMOTE', description: 'Show off your physical power with a muscle flex emote.', iconName: 'Sparkles', rarity: 'UNCOMMON' },
      { tier: 3, level: 20, rewardName: 'Aura: Earth Tremor Steps', rewardType: 'AURA', description: 'Small shockwave rings beneath your feet while walking.', iconName: 'Flame', rarity: 'RARE' },
      { tier: 4, level: 30, rewardName: 'Title: Colossus', rewardType: 'TITLE', description: 'Unlocks the [Colossus] title.', iconName: 'Award', rarity: 'EPIC' },
      { tier: 5, level: 40, rewardName: 'Aura: Titan Amber Glow', rewardType: 'AURA', description: 'Radiant amber steam rising from your shoulders.', iconName: 'Zap', rarity: 'LEGENDARY' },
      { tier: 6, level: 50, rewardName: 'Mastery Cape: Cape of Strength', rewardType: 'CAPE', description: 'Heavy orange cape with gilded bronze pauldrons.', iconName: 'Crown', rarity: 'MYTHIC' },
    ],
  },
  defence: {
    slug: 'defence',
    ...
    staticMilestones: [
      { level: 1, title: 'Bronze Armor', description: 'Equip Bronze Helm, Platebody, and Platelegs.', type: 'EQUIPMENT' },
      { level: 5, title: 'Shield Block', description: 'Activate active block reducing incoming hit damage by 50%.', type: 'ABILITY' },
      { level: 10, title: 'Iron Plate Armor', description: 'Equip full Iron plate armor sets and kiteshields.', type: 'EQUIPMENT' },
      { level: 20, title: 'Steel Bulwark', description: 'Equip heavy Steel plate armor and tower shields.', type: 'EQUIPMENT' },
      { level: 30, title: 'Iron Fortress', description: 'Defensive surge granting temporary immunity to knockback.', type: 'ABILITY' },
      { level: 40, title: 'Rune Armor Set', description: 'Equip masterwork Rune plate armor and shields.', type: 'EQUIPMENT' },
      { level: 50, title: 'Aegis Sentinel', description: 'Passive: 10% chance to reflect 50% of melee damage to attacker.', type: 'PASSIVE' },
    ],
    battlepassTiers: [
      { tier: 1, level: 5, rewardName: 'Title: Defender', rewardType: 'TITLE', description: 'Unlocks the [Defender] title.', iconName: 'Award', rarity: 'COMMON' },
      { tier: 2, level: 10, rewardName: 'Banner: Blue Aegis', rewardType: 'BANNER', description: 'Emblazoned steel shield player card banner.', iconName: 'Flag', rarity: 'UNCOMMON' },
      { tier: 3, level: 20, rewardName: 'Aura: Sapphire Barrier', rewardType: 'AURA', description: 'Soft glowing blue protective forcefield.', iconName: 'Shield', rarity: 'RARE' },
      { tier: 4, level: 35, rewardName: 'Title: The Unyielding', rewardType: 'TITLE', description: 'Unlocks the [The Unyielding] title.', iconName: 'Award', rarity: 'EPIC' },
      { tier: 5, level: 50, rewardName: 'Mastery Cape: Cape of Defence', rewardType: 'CAPE', description: 'Cobalt blue master cape with glowing shield trim.', iconName: 'Crown', rarity: 'MYTHIC' },
    ],
  },
  hitpoints: {
    slug: 'hitpoints',
    ...
    staticMilestones: [
      { level: 1, title: 'Base Vitality (10 HP)', description: 'Starting life essence for new operatives.', type: 'PASSIVE' },
      { level: 10, title: 'Enhanced Circulation (50 HP)', description: 'Regenerate HP 25% faster while resting.', type: 'PASSIVE' },
      { level: 25, title: 'Resilient Core (125 HP)', description: 'Gain 10% resistance against poison and burn status effects.', type: 'PASSIVE' },
      { level: 40, title: 'Iron Blood (200 HP)', description: 'Taking fatal damage leaves you at 1 HP with 2s invulnerability (60s cooldown).', type: 'PASSIVE' },
      { level: 50, title: 'Immortal Vigor (250 HP)', description: 'Passive +50 bonus max HP and constant +2 HP/s aura.', type: 'PASSIVE' },
    ],
    battlepassTiers: [
      { tier: 1, level: 10, rewardName: 'Title: Resilient', rewardType: 'TITLE', description: 'Unlocks the [Resilient] title.', iconName: 'Award', rarity: 'COMMON' },
      { tier: 2, level: 25, rewardName: 'Aura: Emerald Pulse', rewardType: 'AURA', description: 'Soothing emerald heartbeat pulse rings around operative.', iconName: 'Heart', rarity: 'RARE' },
      { tier: 3, level: 50, rewardName: 'Mastery Cape: Cape of Hitpoints', rewardType: 'CAPE', description: 'Regal emerald green cape with life blossom trim.', iconName: 'Crown', rarity: 'MYTHIC' },
    ],
  },
  ranged: {
    slug: 'ranged',
    ...
    staticMilestones: [
      { level: 1, title: 'Wooden Bow & Bronze Arrows', description: 'Equip basic hunting bows and arrows.', type: 'EQUIPMENT' },
      { level: 5, title: 'Quick Shot', description: 'Instant projectile attack with 0.5s cooldown.', type: 'ABILITY' },
      { level: 15, title: 'Oak Shortbow', description: 'Equip Oak Shortbows and Iron Arrows.', type: 'EQUIPMENT' },
      { level: 25, title: 'Snipe Shot', description: 'Charged high-damage shot that deals 2.5x critical damage.', type: 'ABILITY' },
      { level: 35, title: 'Yew Composite Bow', description: 'Equip Yew Bows with +15% armor piercing.', type: 'EQUIPMENT' },
      { level: 50, title: 'Eagle Eye Mastery', description: 'Passive: Projectile hits have 25% chance to retrieve spent ammo.', type: 'PASSIVE' },
    ],
    battlepassTiers: [
      { tier: 1, level: 10, rewardName: 'Title: Marksman', rewardType: 'TITLE', description: 'Unlocks the [Marksman] title.', iconName: 'Award', rarity: 'COMMON' },
      { tier: 2, level: 25, rewardName: 'Aura: Wind Arrow Trails', rewardType: 'AURA', description: 'Whirlwind trail following every fired arrow.', iconName: 'Wind', rarity: 'RARE' },
      { tier: 3, level: 50, rewardName: 'Mastery Cape: Cape of Ranged', rewardType: 'CAPE', description: 'Forest green & gold archer master cloak.', iconName: 'Crown', rarity: 'MYTHIC' },
    ],
  },
  agility: {
    slug: 'agility',
