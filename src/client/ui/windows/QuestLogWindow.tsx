...
export function QuestLogWindow({ isOpen, onClose }: QuestLogWindowProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col font-mono text-xs select-none relative h-full">
        <div className="flex flex-col gap-3 h-full">
            
          {/* Header Tabs */}
          <div className="flex justify-between items-center bg-black/60 p-1.5 rounded-xl border border-amber-500/20 shrink-0">
        ...
        {inspectedQuest && (
          <div className="absolute inset-0 z-50 bg-black/70 flex items-center justify-center p-4 backdrop-blur-xs animate-in fade-in">
            <div 
