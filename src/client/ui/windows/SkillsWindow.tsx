...
export function SkillsWindow({ isOpen, onClose, onSelectSkill, onDeselectSkill }: SkillsWindowProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 font-mono text-xs select-none h-full">
