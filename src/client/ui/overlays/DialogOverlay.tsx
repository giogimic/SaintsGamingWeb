...
export function DialogOverlay() {
  const activeDialog = useWorldStore((state) => state.activeDialog);
  const setActiveDialog = useWorldStore((state) => state.setActiveDialog);
  ...
  const handleOptionClick = (opt: any) => {
    ...
    socketManager.emit('dialogue_select', {
      mapId: currentMapId,
