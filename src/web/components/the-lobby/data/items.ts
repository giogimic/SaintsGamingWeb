...
export const ITEM_DB: Record<string, ItemSchema> = {
  ...
  'celestial_starstrider_greaves': { id: 'celestial_starstrider_greaves', name: 'Celestial Starstrider Greaves', description: 'Transcendent cosmic greaves enabling seamless warp-step blinks across the battlefield.', type: 'LEGS', value: 65000, reqSkill: 'Agility', reqLevel: 50, stats: { def: 60, atk: 35 } },
