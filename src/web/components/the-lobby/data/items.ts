...
export const ITEM_DB: Record<string, ItemSchema> = {
  ...
  'celestial_sovereign_sanctuary': { id: 'celestial_sovereign_sanctuary', name: 'Celestial Sovereign Sanctuary', description: 'Transcendent starlight relic granting continuous group healing wards and elemental invulnerability.', type: 'HEAD', value: 75000, reqSkill: 'Wisdom', reqLevel: 50, stats: { def: 75, hp: 200 } },
