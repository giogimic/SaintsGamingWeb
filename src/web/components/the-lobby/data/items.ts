...
export const ITEM_DB: Record<string, ItemSchema> = {
  ...
  'ancient_spellbook_grimoire': { id: 'ancient_spellbook_grimoire', name: 'Ancientian Ancient Grimoire', description: 'Forbidden spellbook unlocking Ice, Blood, Shadow, and Smoke barrage incantations.', type: 'MATERIAL', value: 15000, reqSkill: 'Magic', reqLevel: 70 },
