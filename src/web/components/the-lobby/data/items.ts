...
export const ITEM_DB: Record<string, ItemSchema> = {
  ...
  'celestial_omniscient_crown': { id: 'celestial_omniscient_crown', name: 'Celestial Omniscient Crown', description: 'Ultimate starlight coronet revealing the cosmic tapestry and guaranteeing lethal critical chain strikes.', type: 'HEAD', value: 75000, reqSkill: 'Perception', reqLevel: 50, stats: { atk: 75, def: 45 } },
