...
export const ITEM_DB: Record<string, ItemSchema> = {
  ...
  'crystal_portal_frame': { id: 'crystal_portal_frame', name: 'Crystal Portal Seraphus Frame', description: 'Attuned teleportation frame linking Sanctuary estate to global cities.', type: 'MATERIAL', value: 8000, reqSkill: 'Construction', reqLevel: 50 },
  ...
  // Potions, Tinctures & Alchemical Elixirs (Herblore Skill Tier Progression)
  'vial_water': { id: 'vial_water', name: 'Vial of Pure Spring Water', description: 'Crystal-clear spring water in glass vial serving as the base for all alchemical brews.', type: 'CONSUMABLE', value: 5, reqSkill: 'Herblore', reqLevel: 1 },
  'attack_potion': { id: 'attack_potion', name: 'Apprentice Attack Draught', description: 'Guam and eye of newt infusion boosting melee attack accuracy by +10% for 5 minutes.', type: 'CONSUMABLE', value: 45, reqSkill: 'Herblore', reqLevel: 3, stats: { atk: 5 } },
  'antipoison_potion': { id: 'antipoison_potion', name: 'Herbal Antipoison Tonic', description: 'Marrentill brew immediately curing venom and granting 90s poison immunity.', type: 'CONSUMABLE', value: 75, reqSkill: 'Herblore', reqLevel: 5 },
  'strength_potion': { id: 'strength_potion', name: 'Warrior Strength Infusion', description: 'Tarromin and limpwurt concoction granting +15% heavy crushing weapon damage.', type: 'CONSUMABLE', value: 120, reqSkill: 'Herblore', reqLevel: 12, stats: { atk: 8 } },
  'restore_potion': { id: 'restore_potion', name: 'Stat Restoration Draught', description: 'Harralander tonic cleansing all combat stat drain debuffs.', type: 'CONSUMABLE', value: 250, reqSkill: 'Herblore', reqLevel: 22, stats: { hp: 30 } },
  'energy_potion': { id: 'energy_potion', name: 'Stamina Energy Tonic', description: 'Harralander and chocolate dust tonic restoring 20% run stamina immediately.', type: 'CONSUMABLE', value: 350, reqSkill: 'Herblore', reqLevel: 26 },
  'prayer_restoration_brew': { id: 'prayer_restoration_brew', name: 'Sacred Ranarr Prayer Brew', description: 'Holy Ranarr herb distillation restoring 35% maximum mana and spiritual ward points.', type: 'CONSUMABLE', value: 800, reqSkill: 'Herblore', reqLevel: 38, stats: { hp: 60 } },
  'super_attack_potion': { id: 'super_attack_potion', name: 'Super Attack Elixir', description: 'Irit and eye of newt overcharge potion granting +20% melee attack rating.', type: 'CONSUMABLE', value: 1500, reqSkill: 'Herblore', reqLevel: 45, stats: { atk: 18 } },
  'super_strength_potion': { id: 'super_strength_potion', name: 'Super Strength Elixir', description: 'Kwuarm and red spider egg blend granting massive brute melee power.', type: 'CONSUMABLE', value: 2500, reqSkill: 'Herblore', reqLevel: 55, stats: { atk: 25 } },
  'super_defence_potion': { id: 'super_defence_potion', name: 'Super Defence Fortification', description: 'Cadantine and white berries brew boosting armor rating by +25%.', type: 'CONSUMABLE', value: 3500, reqSkill: 'Herblore', reqLevel: 66, stats: { def: 30 } },
  'saradomin_vitality_brew': { id: 'saradomin_vitality_brew', name: 'Sacred Vitality Restorative Brew', description: 'Toadflax and crushed bird nest brew boosting current HP over maximum capacity.', type: 'CONSUMABLE', value: 8000, reqSkill: 'Herblore', reqLevel: 81, stats: { hp: 200, def: 20 } },
  'overload_potion': { id: 'overload_potion', name: 'Supreme Overload Concoction', description: 'Masterwork alchemical overcharge maximizing all combat proficiencies simultaneously for 6 minutes.', type: 'CONSUMABLE', value: 25000, reqSkill: 'Herblore', reqLevel: 96, stats: { atk: 40, def: 40, hp: 100 } },
  'celestial_philosopher_elixir': { id: 'celestial_philosopher_elixir', name: 'Celestial Philosopher Ambrosia', description: 'The pinnacle of alchemy granting boundless combat power and continuous life regeneration.', type: 'CONSUMABLE', value: 120000, reqSkill: 'Herblore', reqLevel: 99, stats: { atk: 60, def: 60, hp: 400 } },

  // Pure Essence, Elemental Runes & Runecrafting Accessories (Runecrafting Skill Tier Progression)
  'pure_essence': { id: 'pure_essence', name: 'Dense Pure Rune Essence', description: 'Raw metaphysical stone mined from subterranean rifts, infused with runic potential.', type: 'MATERIAL', value: 4, reqSkill: 'Runecrafting', reqLevel: 1 },
  'rune_air': { id: 'rune_air', name: 'Air Elemental Rune', description: 'Basic aerodynamic catalyst rune for wind strikes and telekinetic spells.', type: 'MATERIAL', value: 4, reqSkill: 'Runecrafting', reqLevel: 1, stats: { atk: 1 } },
  'small_pouch': { id: 'small_pouch', name: 'Small Essence Pouch', description: 'Padded leather pouch holding 3 extra pure essence blocks.', type: 'MATERIAL', value: 150, reqSkill: 'Runecrafting', reqLevel: 1 },
  'air_tiara': { id: 'air_tiara', name: 'Air Runic Tiara', description: 'Silver circlet granting seamless hands-free entry into the Air Altar.', type: 'HEAD', value: 80, reqSkill: 'Runecrafting', reqLevel: 1, stats: { def: 1 } },
  'rune_mind': { id: 'rune_mind', name: 'Mind Catalytic Rune', description: 'Psychic rune focusing beginner telepathic and elemental strike damage.', type: 'MATERIAL', value: 6, reqSkill: 'Runecrafting', reqLevel: 5, stats: { atk: 2 } },
  'rune_water': { id: 'rune_water', name: 'Water Elemental Rune', description: 'Hydrological rune fueling cooling ice barrages and restorative water spells.', type: 'MATERIAL', value: 8, reqSkill: 'Runecrafting', reqLevel: 9, stats: { atk: 2 } },
  'rune_earth': { id: 'rune_earth', name: 'Earth Elemental Rune', description: 'Dense terrestrial rune channeling stone armor spikes and tectonic rifts.', type: 'MATERIAL', value: 10, reqSkill: 'Runecrafting', reqLevel: 14, stats: { atk: 3 } },
  'medium_pouch': { id: 'medium_pouch', name: 'Medium Essence Pouch', description: 'Reinforced runic satchel holding 6 extra pure essence blocks.', type: 'MATERIAL', value: 800, reqSkill: 'Runecrafting', reqLevel: 25 },
  'rune_fire': { id: 'rune_fire', name: 'Fire Elemental Rune', description: 'Combustible thermal rune powering devastating incineration spells.', type: 'MATERIAL', value: 15, reqSkill: 'Runecrafting', reqLevel: 27, stats: { atk: 5 } },
  'rune_chaos': { id: 'rune_chaos', name: 'Chaos Destruction Rune', description: 'Volatile entropic rune fueling chaotic combat burst spells.', type: 'MATERIAL', value: 90, reqSkill: 'Runecrafting', reqLevel: 35, stats: { atk: 10 } },
  'large_pouch': { id: 'large_pouch', name: 'Large Essence Pouch', description: 'Spatial runic sack holding 9 extra pure essence blocks.', type: 'MATERIAL', value: 3500, reqSkill: 'Runecrafting', reqLevel: 50 },
  'rune_nature': { id: 'rune_nature', name: 'Nature Alchemy Rune', description: 'Organic life force rune powering spell transmutation and binding spells.', type: 'MATERIAL', value: 220, reqSkill: 'Runecrafting', reqLevel: 54, stats: { atk: 15 } },
  'rune_law': { id: 'rune_law', name: 'Law Teleportation Rune', description: 'Harmonic planar rune facilitating inter-realm instant teleportation.', type: 'MATERIAL', value: 380, reqSkill: 'Runecrafting', reqLevel: 65, stats: { atk: 20 } },
  'giant_pouch': { id: 'giant_pouch', name: 'Giant Essence Pouch', description: 'Dimensional vortex pouch holding 12 extra pure essence blocks.', type: 'MATERIAL', value: 15000, reqSkill: 'Runecrafting', reqLevel: 75 },
  'rune_death': { id: 'rune_death', name: 'Death Oblivion Rune', description: 'Morbid necrotic rune channeling destructive cataclysmic spells.', type: 'MATERIAL', value: 650, reqSkill: 'Runecrafting', reqLevel: 77, stats: { atk: 30 } },
  'rune_blood': { id: 'rune_blood', name: 'Blood Sanguine Rune', description: 'Crimson blood essence rune fueling devastating vampiric life-drain spells.', type: 'MATERIAL', value: 1200, reqSkill: 'Runecrafting', reqLevel: 88, stats: { atk: 45 } },
  ...
  // Lockpicks, Stealth Disguises & Rogue Infiltration Gear (Thieving Skill Tier Progression)
  'wire_lockpick': { id: 'wire_lockpick', name: 'Tempered Steel Lockpick', description: 'Slender tension wrench and pick set used to crack wooden chest locks and dungeon gates.', type: 'MATERIAL', value: 15, reqSkill: 'Thieving', reqLevel: 1 },
  'black_silk_mask': { id: 'black_silk_mask', name: 'Black Silk Bandit Mask', description: 'Conceals operative face and identity, reducing suspicion when looting market stalls.', type: 'HEAD', value: 85, reqSkill: 'Thieving', reqLevel: 10, stats: { def: 2 } },
  'smoke_bomb': { id: 'smoke_bomb', name: 'Dense Charcoal Smoke Bomb', description: 'Throws a thick cloud of obscuring smoke to break guard line-of-sight and stun pursuers.', type: 'CONSUMABLE', value: 150, reqSkill: 'Thieving', reqLevel: 25 },
  'nitrogen_flash_powder': { id: 'nitrogen_flash_powder', name: 'Nitrogen Flash Smoke Powder', description: 'Blinding flash concoction that instantly stuns high-tier city watchmen for 8 seconds.', type: 'CONSUMABLE', value: 450, reqSkill: 'Thieving', reqLevel: 35 },
  'padded_rogue_boots': { id: 'padded_rogue_boots', name: 'Muffled Rogue Boots', description: 'Velvet-soled stealth boots completely eliminating footstep noise on stone floors.', type: 'LEGS', value: 1200, reqSkill: 'Thieving', reqLevel: 50, stats: { def: 12 } },
  'rogue_shadow_tunic': { id: 'rogue_shadow_tunic', name: 'Midnight Rogue Vestment', description: 'Camouflaged shadow tunic providing a +15% bonus to pickpocket success rate.', type: 'CHEST', value: 3500, reqSkill: 'Thieving', reqLevel: 60, stats: { def: 24 } },
  'diamond_vault_keycard': { id: 'diamond_vault_keycard', name: 'Royal Diamond Safe Keycard', description: 'Forged high-clearance bypass keycard unlocking impenetrable bullion vaults.', type: 'MATERIAL', value: 12000, reqSkill: 'Thieving', reqLevel: 80 },
  'shadow_infiltration_cloak': { id: 'shadow_infiltration_cloak', name: 'Shadow Infiltration Cloak', description: 'Ethereal cloak that blends the wearer into ambient darkness, avoiding camera and guard aggro.', type: 'CHEST', value: 30000, reqSkill: 'Thieving', reqLevel: 90, stats: { def: 45, hp: 100 } },
  'celestial_shadow_stiletto': { id: 'celestial_shadow_stiletto', name: 'Celestial Eclipse Shadow Stiletto', description: 'Mythic void-forged stiletto that strikes from the dark with guaranteed critical backstabs and infinite pickpocket mastery.', type: 'WEAPON', value: 120000, reqSkill: 'Thieving', reqLevel: 99, stats: { atk: 90, def: 25, hp: 120 } },

  // Spirit Shards, Charms, Familiar Pouches & Pact Matrices (Summoning Skill Tier Progression)
  'spirit_shards': { id: 'spirit_shards', name: 'Resonant Spirit Shards', description: 'Crystalline metaphysical shards used as standard currency in all familiar pouch binding.', type: 'MATERIAL', value: 25, reqSkill: 'Summoning', reqLevel: 1 },
  'gold_charm': { id: 'gold_charm', name: 'Gold Summoning Charm', description: 'Luminescent golden charm dropped by beasts, used to bind basic familiar spirits.', type: 'MATERIAL', value: 50, reqSkill: 'Summoning', reqLevel: 1 },
  'spirit_wolf_pouch': { id: 'spirit_wolf_pouch', name: 'Spirit Wolf Summoning Pouch', description: 'Summons a loyal spirit wolf companion that fights alongside you with howl attacks.', type: 'CONSUMABLE', value: 120, reqSkill: 'Summoning', reqLevel: 1, stats: { atk: 4 } },
  'green_charm': { id: 'green_charm', name: 'Green Summoning Charm', description: 'Verdant nature charm harnessing subterranean and desert spirit energy.', type: 'MATERIAL', value: 150, reqSkill: 'Summoning', reqLevel: 18 },
  'desert_wyrm_pouch': { id: 'desert_wyrm_pouch', name: 'Desert Wyrm Summoning Pouch', description: 'Summons a subterranean sand wyrm that burrows under enemy defenses.', type: 'CONSUMABLE', value: 450, reqSkill: 'Summoning', reqLevel: 18, stats: { atk: 10 } },
  'crimson_charm': { id: 'crimson_charm', name: 'Crimson Summoning Charm', description: 'Potent crimson charm pulsing with fierce predatory familiar essence.', type: 'MATERIAL', value: 600, reqSkill: 'Summoning', reqLevel: 52 },
  'spirit_terrorbird_pouch': { id: 'spirit_terrorbird_pouch', name: 'Spirit Terrorbird Pouch', description: 'Summons a 12-slot beast of burden that regenerates running stamina and carries heavy supplies.', type: 'CONSUMABLE', value: 1800, reqSkill: 'Summoning', reqLevel: 52, stats: { hp: 50 } },
  'blue_charm': { id: 'blue_charm', name: 'Blue Summoning Charm', description: 'Ultra-rare sapphire charm binding titan-class war familiars and behemoths.', type: 'MATERIAL', value: 1500, reqSkill: 'Summoning', reqLevel: 67 },
  'war_tortoise_pouch': { id: 'war_tortoise_pouch', name: 'War Tortoise Summoning Pouch', description: 'Summons an armored 18-slot war tortoise that provides high defensive bulwarks.', type: 'CONSUMABLE', value: 4500, reqSkill: 'Summoning', reqLevel: 67, stats: { def: 25, hp: 100 } },
  'bunyip_pouch': { id: 'bunyip_pouch', name: 'Bunyip Aquatic Pouch', description: 'Summons a mystical aquatic bunyip providing continuous passive health regeneration in combat.', type: 'CONSUMABLE', value: 5000, reqSkill: 'Summoning', reqLevel: 68, stats: { hp: 150 } },
  'pack_yak_pouch': { id: 'pack_yak_pouch', name: 'Pack Yak Summoning Pouch', description: 'Summons the legendary 30-slot beast of burden with winter storage teleport scrolls.', type: 'CONSUMABLE', value: 25000, reqSkill: 'Summoning', reqLevel: 96, stats: { def: 35, hp: 300 } },
  'steel_titan_pouch': { id: 'steel_titan_pouch', name: 'Steel Titan Summoning Pouch', description: 'Summons a gargantuan steel war machine firing deadly steel cannonball artillery volleys.', type: 'CONSUMABLE', value: 65000, reqSkill: 'Summoning', reqLevel: 99, stats: { atk: 75, def: 50, hp: 400 } },
  'celestial_apex_chimera_matrix': { id: 'celestial_apex_chimera_matrix', name: 'Celestial Apex Chimera Crown', description: 'Mythic crown binding cosmic apex predator spirits, granting double familiar summon slots and infinite spiritual energy.', type: 'HEAD', value: 120000, reqSkill: 'Summoning', reqLevel: 99, stats: { atk: 80, def: 40, hp: 250 } },

  // Elemental Staves, Mystic Robes & Arcane Grimoires (Magic Skill Tier Progression)
  'apprentice_staff': { id: 'apprentice_staff', name: 'Apprentice Carved Wand', description: 'Basic enchanted wooden wand providing unlimited basic wind strikes.', type: 'WEAPON', value: 120, reqSkill: 'Magic', reqLevel: 1, stats: { atk: 6 } },
  'air_battle_staff': { id: 'air_battle_staff', name: 'Gale Air Battlestaff', description: 'Enchanted orb staff channeling infinite atmospheric wind runes.', type: 'WEAPON', value: 1500, reqSkill: 'Magic', reqLevel: 30, stats: { atk: 22 } },
  'mystic_robe_top': { id: 'mystic_robe_top', name: 'Mystic Indigo Robe Top', description: 'Consecrated silk garment imbued with arcane spell amplifier sigils.', type: 'CHEST', value: 3500, reqSkill: 'Magic', reqLevel: 40, stats: { atk: 15, def: 18 } },
  'fire_battle_staff': { id: 'fire_battle_staff', name: 'Pyromancer Battlestaff', description: 'Blazing ruby battlestaff granting infinite fire rune incantations and +25% burn damage.', type: 'WEAPON', value: 6500, reqSkill: 'Magic', reqLevel: 50, stats: { atk: 38 } },
  'ancient_spellbook_grimoire': { id: 'ancient_spellbook_grimoire', name: 'The Ancientian Ancient Grimoire', description: 'Forbidden spellbook unlocking Ice, Blood, Shadow, and Smoke barrage incantations.', type: 'MATERIAL', value: 15000, reqSkill: 'Magic', reqLevel: 70 },
  'infinity_silk_robes': { id: 'infinity_silk_robes', name: 'Infinity Prismatic Robe', description: 'Woven from luminous cosmic silk offering top-tier magic accuracy and elemental resistance.', type: 'CHEST', value: 28000, reqSkill: 'Magic', reqLevel: 75, stats: { atk: 35, def: 30, hp: 60 } },
  'master_elemental_staff': { id: 'master_elemental_staff', name: 'Staff of Limitless Elements', description: 'Grandmaster catalyst providing infinite Air, Water, Earth, and Fire elemental runes simultaneously.', type: 'WEAPON', value: 45000, reqSkill: 'Magic', reqLevel: 85, stats: { atk: 65, hp: 80 } },
  'celestial_archmage_singularity_staff': { id: 'celestial_archmage_singularity_staff', name: 'Celestial Archmage Singularity Staff', description: 'Transcendent starmetal staff concentrating miniature black holes to annihilate foes with infinite elemental barrages.', type: 'WEAPON', value: 120000, reqSkill: 'Magic', reqLevel: 99, stats: { atk: 95, def: 30, hp: 160 } },

  // Holy Relics, Bones, Consecrated Ashes & Divine Vestments (Prayer Skill Tier Progression)
  'clean_bones': { id: 'clean_bones', name: 'Clean Animal Bones', description: 'Standard starter bones that provide basic divine faith when buried in sacred soil.', type: 'MATERIAL', value: 15, reqSkill: 'Prayer', reqLevel: 1 },
  'holy_symbol': { id: 'holy_symbol', name: 'Blessed Silver Holy Symbol', description: 'Consecrated holy amulet granting increased prayer point retention and passive faith regeneration.', type: 'HEAD', value: 150, reqSkill: 'Prayer', reqLevel: 8, stats: { def: 6, hp: 20 } },
  'big_bones': { id: 'big_bones', name: 'Giant Beast Bones', description: 'Dense mammoth and ogre bones releasing potent spiritual energy upon prayer burial.', type: 'MATERIAL', value: 90, reqSkill: 'Prayer', reqLevel: 15 },
  'monk_robes': { id: 'monk_robes', name: 'Sanctified Monk Vestment', description: 'Humble linen monk robe that substantially slows down prayer point drain during combat.', type: 'CHEST', value: 750, reqSkill: 'Prayer', reqLevel: 31, stats: { def: 12, hp: 40 } },
  'dragon_bones': { id: 'dragon_bones', name: 'Ancient Dragon Bones', description: 'Mythic wyrm bones yielding massive holy faith XP when offered upon gilded altars.', type: 'MATERIAL', value: 1800, reqSkill: 'Prayer', reqLevel: 70 },
  'infernal_ashes': { id: 'infernal_ashes', name: 'Demonic Infernal Ashes', description: 'Consecrated demonic ashes releasing blazing divine sanctification when scattered.', type: 'MATERIAL', value: 4500, reqSkill: 'Prayer', reqLevel: 85 },
  'sanctified_templar_vestment': { id: 'sanctified_templar_vestment', name: 'Sanctified Templar Robe', description: 'Gilded crusader robe granting +25% prayer aura duration and supreme holy protection.', type: 'CHEST', value: 32000, reqSkill: 'Prayer', reqLevel: 90, stats: { def: 45, hp: 140 } },
  'celestial_hierophant_crown': { id: 'celestial_hierophant_crown', name: 'Celestial Hierophant Halo Crown', description: 'Mythic golden sun halo granting 100% overhead prayer protection uptime and infinite divine faith.', type: 'HEAD', value: 120000, reqSkill: 'Prayer', reqLevel: 99, stats: { atk: 60, def: 55, hp: 300 } },

  // Necrotic Conduits, Bone Wands, Soul Urns & Death Scythes (Necromancy Skill Tier Progression)
  'initiate_bone_wand': { id: 'initiate_bone_wand', name: 'Initiate Necrotic Bone Wand', description: 'Carved bone focus used to channel basic soul sap incantations and summon skeleton warriors.', type: 'WEAPON', value: 150, reqSkill: 'Necromancy', reqLevel: 1, stats: { atk: 8 } },
  'necrotic_soul_urn': { id: 'necrotic_soul_urn', name: 'Earthen Soul Urn', description: 'Ceramic ritual vessel capturing harvested wandering souls during necro-communion rites.', type: 'MATERIAL', value: 250, reqSkill: 'Necromancy', reqLevel: 10 },
  'death_guard_robes': { id: 'death_guard_robes', name: 'Death Guard Plate-Shroud', description: 'Reinforced obsidian shroud providing necrotic life siphon and +15% undead conjure damage.', type: 'CHEST', value: 2200, reqSkill: 'Necromancy', reqLevel: 30, stats: { atk: 15, def: 18 } },
  'spectral_spirit_lantern': { id: 'spectral_spirit_lantern', name: 'Spectral Spirit Lantern', description: 'Offhand necrotic conduit trapping tortured wraiths to unleash devastating haunt curses.', type: 'MATERIAL', value: 6500, reqSkill: 'Necromancy', reqLevel: 50 },
  'deathdealer_scythe': { id: 'deathdealer_scythe', name: 'Deathdealer Heavy Scythe', description: 'Forged obsidian scythe executing foes below 20% HP and transferring stolen health to operative.', type: 'WEAPON', value: 25000, reqSkill: 'Necromancy', reqLevel: 70, stats: { atk: 55, hp: 80 } },
