...
export const DOCK_ZONE_DEFINITIONS: Record<DockZoneId, DockZoneMeta> = {
  'top-left': {
    ...
    cssAnchor: 'top-14 sm:top-12 left-4',
  ...
  'top-center': {
    ...
    cssAnchor: 'top-14 sm:top-12 left-1/2 -translate-x-1/2',
    defaultOrientation: 'vertical',
  },
  'top-right': {
    id: 'top-right',
    ...
    cssAnchor: 'top-14 sm:top-12 right-4',
    defaultOrientation: 'vertical',
  },
  'mid-left': {
    id: 'mid-left',
  ...
  'bottom-left': {
    ...
    cssAnchor: 'bottom-14 sm:bottom-10 left-4',
    defaultOrientation: 'vertical',
  },
  'bottom-center': {
    id: 'bottom-center',
    ...
    cssAnchor: 'bottom-14 sm:bottom-10 left-1/2 -translate-x-1/2',
  ...
  'bottom-right': {
    ...
    cssAnchor: 'bottom-14 sm:bottom-10 right-4',
