...
export const DOCK_ZONE_DEFINITIONS: Record<DockZoneId, DockZoneMeta> = {
  'top-left': {
    id: 'top-left',
    label: 'Top Left',
    description: 'Player status, vitals, and buff tray',
    cssAnchor: 'top-3 left-3',
  ...
  'top-center': {
    ...
    cssAnchor: 'top-3 left-1/2 -translate-x-1/2',
    defaultOrientation: 'vertical',
  },
  'top-right': {
    id: 'top-right',
    label: 'Top Right',
    description: 'Minimap radar, compass, and system stats',
    cssAnchor: 'top-3 right-3',
    defaultOrientation: 'vertical',
  },
  'mid-left': {
    id: 'mid-left',
    ...
    cssAnchor: 'top-1/3 left-3 -translate-y-1/4',
    defaultOrientation: 'vertical',
  },
  'mid-right': {
    id: 'mid-right',
    label: 'Mid Right',
    description: 'Active quest tracker and task log',
    cssAnchor: 'top-1/4 right-3',
    defaultOrientation: 'vertical',
  },
  'bottom-left': {
    id: 'bottom-left',
    label: 'Bottom Left',
    description: 'Game chat, combat logs, and channel tabs',
    cssAnchor: 'bottom-3 left-3',
    defaultOrientation: 'vertical',
  },
  'bottom-center': {
    id: 'bottom-center',
    label: 'Bottom Center',
    description: 'Main ability hotbar and action buttons',
    cssAnchor: 'bottom-3 left-1/2 -translate-x-1/2',
    defaultOrientation: 'horizontal',
  },
  'bottom-right': {
    id: 'bottom-right',
    label: 'Bottom Right',
    description: 'Tabbed utility hub (Inventory, Skills, Equipment, GTC)',
    cssAnchor: 'bottom-3 right-3',
