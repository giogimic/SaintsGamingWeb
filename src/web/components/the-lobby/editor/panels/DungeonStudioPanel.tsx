        ...
        <div className="flex-1 p-4 overflow-y-auto">
          <div className="max-w-2xl space-y-6">
            ...
            <div className="space-y-4 bg-slate-900/50 p-4 rounded border border-slate-800">
              <h3 className="text-sm font-semibold text-blue-400 border-b border-slate-800 pb-2">Basic Info</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-slate-500">ID</label>
                  <input type="text" className="w-full bg-black/50 border border-slate-700 rounded px-2 py-1 text-slate-300" disabled value="example_dungeon_1" />
                </div>
                <div className="space-y-1">
                  <label className="text-slate-500">Name</label>
                  <input type="text" className="w-full bg-slate-950 border border-slate-700 rounded px-2 py-1 text-slate-300 focus:border-blue-500 outline-none" defaultValue="Example Dungeon" />
                </div>
                <div className="space-y-1 col-span-2">
                  <label className="text-slate-500">Description</label>
                  <textarea className="w-full bg-slate-950 border border-slate-700 rounded px-2 py-1 text-slate-300 focus:border-blue-500 outline-none h-20" defaultValue="A dark and scary place." />
                </div>
              </div>
            </div>

            <div className="space-y-4 bg-slate-900/50 p-4 rounded border border-slate-800">
              <h3 className="text-sm font-semibold text-blue-400 border-b border-slate-800 pb-2">Requirements & Limits</h3>
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-1">
                  <label className="text-slate-500">Min Level</label>
                  <input type="number" className="w-full bg-slate-950 border border-slate-700 rounded px-2 py-1 text-slate-300" defaultValue="1" />
                </div>
                <div className="space-y-1">
                  <label className="text-slate-500">Max Level</label>
                  <input type="number" className="w-full bg-slate-950 border border-slate-700 rounded px-2 py-1 text-slate-300" placeholder="None" />
                </div>
                <div className="space-y-1">
                  <label className="text-slate-500">Max Players</label>
                  <input type="number" className="w-full bg-slate-950 border border-slate-700 rounded px-2 py-1 text-slate-300" defaultValue="4" />
                </div>
              </div>
              <div className="pt-2">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" defaultChecked className="rounded bg-slate-900 border-slate-700 text-blue-500 focus:ring-blue-500" />
            ...
            <div className="space-y-4 bg-slate-900/50 p-4 rounded border border-slate-800">
              <h3 className="text-sm font-semibold text-amber-400 border-b border-slate-800 pb-2 flex justify-between items-center">
                ...
                <button className="px-2 py-0.5 bg-slate-800 rounded text-slate-300 border border-slate-700 hover:bg-slate-700">Edit Rules</button>
              </h3>
              <div className="p-2 bg-black/40 border border-slate-800 rounded font-mono text-[10px] text-slate-400">
                {`{
  "type": "AND",
  "conditions": [
    { "type": "HAS_ITEM", "itemId": "dungeon_key_1", "qty": 1 }
            ...
            <div className="space-y-4 bg-slate-900/50 p-4 rounded border border-slate-800">
              <h3 className="text-sm font-semibold text-emerald-400 border-b border-slate-800 pb-2 flex justify-between items-center">
                ...
                <button className="px-2 py-0.5 bg-slate-800 rounded text-slate-300 border border-slate-700 hover:bg-slate-700">Add Map</button>
              </h3>
              <div className="space-y-2">
                <div className="flex items-center justify-between p-2 bg-black/40 border border-slate-800 rounded">
