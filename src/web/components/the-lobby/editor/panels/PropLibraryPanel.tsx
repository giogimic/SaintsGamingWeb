...
const BUILTIN_PROPS: BuiltinProp[] = [
  ...
  {
    id: 'prop_crystal_cluster',
    name: 'Cyan Aether Crystal',
    category: 'Decor',
    sheetUrl: '/game-assets/tilesets/terrain-overworld.png',
    uOffset: 0.875,
    vOffset: 0.375,
  ...
  {
    id: 'prop_dungeon_torch',
    name: 'Iron Sconce Torch',
    category: 'Decor',
    sheetUrl: '/game-assets/tilesets/terrain-overworld.png',
    uOffset: 0.625,
    vOffset: 0.375,
