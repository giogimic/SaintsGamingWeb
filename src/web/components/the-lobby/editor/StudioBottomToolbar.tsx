...
export const StudioBottomToolbar: React.FC<StudioBottomToolbarProps> = () => {
  ...
  return (
    <div className="pointer-events-auto fixed bottom-0 left-0 right-0 h-9 z-[110] bg-[#050b14]/90 border-t border-border/50 flex items-center justify-between px-3 select-none backdrop-blur-xl shadow-lg font-mono text-xs text-foreground overflow-x-auto no-scrollbar gap-2">
