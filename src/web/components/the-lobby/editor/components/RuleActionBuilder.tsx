                    ...
                    onChange={(e) => {
                      ...
                      switch (kind) {
                        ...
                        case 'SEND_NOTIFICATION':
                          ...
                          break;
                        case 'SPAWN_ENTITY':
                          updateActionAt(i, { kind: 'SPAWN_ENTITY', entityId: 'entity_slug', entityType: 'MONSTER', mapId: '', x: 0, y: 0 });
                          break;
                        case 'TELEPORT_PLAYER':
                          updateActionAt(i, { kind: 'TELEPORT_PLAYER', mapId: '', x: 10, y: 10 });
                          break;
                      }
                    }}
        ...
        <div className="grid grid-cols-3 gap-2">
          <label className="flex flex-col gap-1 text-[10px] text-slate-400">
            ...
            <input
              ...
              className="rounded bg-black/50 px-2 py-1 border border-slate-700 text-slate-200 font-mono"
              placeholder="e.g. SAINTS_VILLAGE"
            />
          </label>
          <label className="flex flex-col gap-1 text-[10px] text-slate-400">
            X
