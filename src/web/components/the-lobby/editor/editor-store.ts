...
const DEFAULT_PANELS = {
  ...
  mapEditor: {
    ...
    isOpen: false,
    isCollapsed: false,
    x: typeof window !== 'undefined' ? Math.max(20, (window.innerWidth - 700) / 2) : 300,
    y: typeof window !== 'undefined' ? Math.max(20, (window.innerHeight - 550) / 2) : 150,
    width: 700,
    height: 550,
    zIndex: 10,
  },
