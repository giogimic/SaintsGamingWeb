...
export const ADMIN_MODULES: AdminModule[] = [
  ...
  },
  {
    id: "game-tuxemon",
    category: "operations",
    label: "Beast Species Catalog",
    description: "Explore 400+ registered creature species, element types, and moves.",
    icon: Gamepad2,
    href: "/admin/game-dev/tuxemon",
    permission: PERMISSION_LEVELS.DEVELOPER,
    keywords: ["tuxemon", "creatures", "beasts", "pokedex", "species", "stats", "moves", "abilities"],
  },
  {
    id: "game-assets",
    category: "operations",
  ...
  // ─── GAME SERVERS & INFRASTRUCTURE ─────────────────────────────────────────
  {
    ...
    permission: PERMISSION_LEVELS.ADMIN,
    keywords: ["servers", "game servers", "Creature Battler", "dedicated", "maintenance", "ip", "ports"],
  },
  {
    id: "servers-modpacks",
    category: "infrastructure",
