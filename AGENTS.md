...
- `/studio` sets `isEditorMode` (`src/shared/game/studioSession.ts`). Create tools (`isCreationMode`) soft-suppress encounters/combat; Walk Mode re-enables play-test. Phase 1: `17-studio-world-builder-economy.md`. Systems: `18`. UX: `19`. Entities/components/prefabs: `20-studio-entity-system.md`. Loot Manager: `/api/loot/tables`.
