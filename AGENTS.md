...
- `/studio` sets `isEditorMode` (`src/shared/game/studioSession.ts`). Create tools (`isCreationMode`) soft-suppress encounters/combat; Walk Mode re-enables play-test. Docs: `17`–`22` (systems, UX, entities, world tools, NPC/AI/creature editors). Loot Manager: `/api/loot/tables`.
