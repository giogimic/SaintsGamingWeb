...
- `/studio` sets `isEditorMode` (`src/shared/game/studioSession.ts`). Create tools (`isCreationMode`) soft-suppress encounters/combat; Walk Mode re-enables play-test. Docs: `17`–`24` (through quest editor). Loot: `/api/loot/tables`. Economy: `23`. Quests: `24-studio-quest-editor.md`.
