...
- `/studio` sets `isEditorMode` (`src/shared/game/studioSession.ts`). Create tools (`isCreationMode`) soft-suppress encounters/combat; Walk Mode re-enables play-test. Docs: `17`–`25` (through gameplay editors). Ability/combat SoT design: `25-studio-gameplay-editors.md`. Economy: `23`. Quests: `24`.
