...
- `/studio` sets `isEditorMode` (`src/shared/game/studioSession.ts`). Create tools (`isCreationMode`) soft-suppress encounters/combat; Walk Mode re-enables play-test. Docs: `17` Phase 1 · `18` systems · `19` UX · `20` entities · `21` world-building tools. Loot Manager: `/api/loot/tables`.
