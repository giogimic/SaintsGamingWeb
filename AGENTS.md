...
- `/studio` sets `isEditorMode` (`src/shared/game/studioSession.ts`). Create tools (`isCreationMode`) soft-suppress encounters/combat; Walk Mode re-enables play-test. Docs: `17`–`23` (through economy). Loot Manager: `/api/loot/tables`. Item/loot SoT design: `23-studio-economy-system.md`.
