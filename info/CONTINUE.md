...
6. **Next:** human `DEMO_SMOKE.md`; optional per-dock permission matrix / Admin-only Dev Tools — do **not** invent Five Modes / Advanced Tier / publish flow without product ask
