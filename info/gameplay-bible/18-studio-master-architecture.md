...
**This document is the master.** `08` owns layer physics truth. `16` owns feel. `17` owns Phase 1 contracts. `18` owns systems. [`19`](./19-studio-ux-design.md) UX · [`20`](./20-studio-entity-system.md) entities · [`21`](./21-studio-world-building-tools.md) world tools · [`22`](./22-studio-npc-ai-creature-editors.md) NPC/AI/creatures · [`23`](./23-studio-economy-system.md) economy · [`24`](./24-studio-quest-editor.md) quests · [`25`](./25-studio-gameplay-editors.md) **gameplay editors**.
