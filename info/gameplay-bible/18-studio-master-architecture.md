...
**This document is the master.** `08` owns layer physics truth. `16` owns feel. `17` owns Phase 1 contracts. `18` owns **system inventory, unification rules, subsystem specs, and how every future feature plugs in**.
