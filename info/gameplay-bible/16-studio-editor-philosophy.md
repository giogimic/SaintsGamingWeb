...
Saints Studio is not a secondary tool bolted onto the game. It is the product surface where worlds are born. The architectural layers of map data, logic tiles, and object placement are defined in [`08-world-building-editor-architecture.md`](./08-world-building-editor-architecture.md). This document defines how creating should *feel*.
