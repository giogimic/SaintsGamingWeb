...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: 'next/cache', replacement: path.resolve(__dirname, './src/shims/nextCacheShim.ts') },
      { find: 'next/headers', replacement: path.resolve(__dirname, './src/shims/nextHeadersShim.ts') },
      { find: 'next/server', replacement: path.resolve(__dirname, './src/shims/nextServerShim.ts') },
      { find: /^@\/app\/actions\/(.*)/, replacement: path.resolve(__dirname, './src/shims/actions/$1') },
      { find: '@/app/actions', replacement: path.resolve(__dirname, './src/shims/actions') },
